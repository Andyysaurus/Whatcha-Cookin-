...
public class RequirementsAdapter {
	...
	static final String DATABASE_CREATE = "CREATE TABLE " + "REQUIREMENTS" +
			"( " + "NAME text, INGREDIENTS text, QUANTITY integer, primary key (NAME, INGREDIENTS)" + ")";
	...
	public RequirementsAdapter(Context _context) {
		context = _context;
		dbHelper = new DataBaseHelper(context, DATABASE_NAME, null, DATABASE_VERSION);
	}
	
	public RequirementsAdapter open() throws SQLException {
	...
	public void insertIngredientEntry(String name, String ingredient,  Integer quantity) {
		ContentValues newValues = new ContentValues();
		newValues.put("NAME", name);
		newValues.put("QUANTITY", quantity);
		newValues.put("INGREDIENTS", ingredient);
		db.insert("REQUIREMENTS", null, newValues);
	}
