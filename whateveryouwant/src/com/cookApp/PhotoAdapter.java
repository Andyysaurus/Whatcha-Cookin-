...
public class PhotoAdapter {
	static final String DATABASE_NAME = "molephotos.db";
	static final int DATABASE_VERSION = 1;
	public static final int NAME_COLUMN = 1;
	
	static final String DATABASE_CREATE = "CREATE TABLE " + "MOLEPHOTOS" +
			"( " +"ID"+" integer primary key autoincrement, "+ "LOCATION text, AREA text, PHOTO text " + ")";
	...
	public PhotoAdapter open() throws SQLException {
	...
	public void insertPhotoEntry(String mlocation, String area, String photo) {
		ContentValues newValues = new ContentValues();
		newValues.put("LOCATION", mlocation);
		newValues.put("AREA", area);
		newValues.put("PHOTO", photo);
		db.insert("MOLEPHOTOS", null, newValues);
	}
